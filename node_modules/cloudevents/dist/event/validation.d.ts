...
export declare const isBinary: (v: unknown) => v is Uint32Array;
...
export declare const asBuffer: (value: string | Buffer | Uint32Array) => Buffer;
export declare const asBase64: (value: string | Buffer | Uint32Array) => string;
...
export declare const isValidType: (v: boolean | number | string | Date | Uint32Array | unknown) => boolean;
